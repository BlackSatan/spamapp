...
# print(sc_tf_idf.classify(process_message('you are winner')))
# print(sc_tf_idf)
# print(testData)
...
def classify_words(words: list):
    ...
    with open('sc_bow.pkl', 'rb') as fid:
        sc_bow = cPickle.load(fid)
    result_list = []
    for sms in words:
        result_list.append(sc_bow.classify(process_message(sms)))
    if len(words) != len(result_list):
        print('PROBLEMES')
    return result_list
